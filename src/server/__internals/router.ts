...
import { Bindings, MiddlewareHandler, Next, Variables } from 'hono/types'
...
} from '@/server/__internals/middleware'
import { MutationOperation, QueryOperation } from '@/server/__internals/types'
